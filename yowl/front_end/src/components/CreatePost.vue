...
<div v-if="toggle" @click="create" id="product-add"><i class="fa fa-plus add"></i></div>
<div v-else class="popup">
  <div v-if="loading" class="loader"><img src='../assets/images/loading.gif' /> </div>
        <div class="v81_1058"><span class="popup-title">Add a post</span>
            <div class="v81_1068"><textarea class="opinion" v-model='content' placeholder="Your opinion here"></textarea></div>
            <div class="v81_1070">
                <div class="v81_1071"><input type="text" v-model='url' class="post-url" placeholder="The link of the thing here"></div>
